...
vows.describe('director/core/mount').addBatch({"An instance of director.Router": {
        ...
        "should sanitize the routes correctly": function(router) {
          ...
          router.mount({
            ...
            '/foo': {
              '/bar': foobar,
              '/*': foostar,
              '/jitsu/then': {before: foobar}
            },
            '/foo/bazz': {'/buzz': foobazzbuzz},
            '/foo/jitsu': {'/then': fnArray},
    ...
    "with preconfigured params": {
      ...
      "should sanitize the routes correctly": function(router) {
        ...
        router.mount({
          ...
          '/world': {'/:country': {'/:city/:zip': countryCityZip}}
        });
